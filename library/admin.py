...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'itemld', 'created', 'customer',)

admin.site.register(Order, OrderAdmin)


class AuthorAdmin(admin.ModelAdmin):
    list_display = ('id', 'first_name', 'last_name', 'birthyear', 'email',)
...
class BookAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'title', 'publisher', 'count', 'avatar_small', 'description',)
